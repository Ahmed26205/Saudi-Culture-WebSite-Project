  ...
  <header id="mainHeader">
    ...
    <section class="main-visual-section">
        ...
        <div class="main-visual-content">
            <h1>موروث</h1>
            <p>موقع تفاعلي يسلط الضوء على الموروث الثقافي في المملكة العربية السعودية.</p>
            <p>ابدأ رحلتك الآن....</p>
...
<section class="poetry-section">
    <div class="poetry-list">
        ...
        <article class="poetry-card">
            ...
            <div class="poetry-content">
                ...
                <p class="poet-origin">أمير منطقة مكة المكرمة</p>
        ...
        <article class="poetry-card">
            ...
            <div class="poetry-content">
                ...
                <p class="poet-origin">من أشهر الشعراء السعوديين – وزير وسفير سابق</p>
                <blockquote class="poet-quote">
                     <p>
            يا وطناً شامخاً تسمو المآثرُ فيه<br>
            ما زلتَ في مهجتي عشقاً أُرتِّلهُ
        </p>
                </blockquote>
            </div>
        </article>
        ...
        <article class="poetry-card">
            ...
            <div class="poetry-content">
                ...
                <p class="poet-origin">شاعر وكاتب سعودي</p>
                <blockquote class="poet-quote">
                    <p>
    ...
    <!-- عنوان لقسم البطاقات المميزة -->
    <h2 class="section-title">الأقسام المميزة</h2>

    <!-- شبكة بطاقات تعرض أهم أقسام الموقع -->
    <div class="cards">
   ...
   <section class="regions-journey">
    <h2 class="section-title">رحلة في مناطق المملكة</h2>
    ...
    <div class="regions-grid">
        ...
        <article class="region-card">
            ...
            <p>
                ...
                والمعمار القديم في جدة التاريخية.
            </p>
        </article>
        ...
        <article class="region-card">
            ...
            <p>
                ...
                وتشتهر بالصناعات والحرف البحرية القديمة.
            </p>
        </article>
        ...
        <article class="region-card">
            ...
            <p>
                ...
                والأزياء الملونة التي تعكس هوية المنطقة.
            </p>
        </article>
    ...
    <!-- عنوان قسم استكشاف الفعاليات -->
    <h2 class="section-title">اكتشف أكثر عن السعودية</h2>

    <!-- قسم الفعاليات الثقافية (نص + زر + صورة) -->
